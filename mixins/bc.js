      ...
      var Libbcmath = {
          ...
          if (n1.n_sign === n2.n_sign) {
            ...
            switch (cmpRes) {
              ...
              case 0:
                ...
                resScale = Libbcmath.MAX(
                  scaleMin,
                  Libbcmath.MAX(n1.n_scale, n2.n_scale),
                );
        ...
        bc_divide: function(n1, n2, scale) {
          ...
          if (n2.n_scale === 0) {
            if (n2.n_len === 1 && n2.n_value[0] === 1) {
              ...
              qval.n_sign =
                n1.n_sign === n2.n_sign ? Libbcmath.PLUS : Libbcmath.MINUS;
          ...
          if (!zero) {
            ...
            while (qdig <= len1 + scale - len2) {
              ...
              if (n2.n_value[n2ptr] === num1[qdig]) {
                ...
                qguess = Math.floor(
                  (num1[qdig] * 10 + num1[qdig + 1]) / n2.n_value[n2ptr],
                );
              }
              // Test qguess.
        ...
        _bc_do_add: function(n1, n2, scaleMin) {
          ...
          sum = Libbcmath.bc_new_num(
            sumDigits,
            Libbcmath.MAX(sumScale, scaleMin),
          );
        ...
        _bc_do_sub: function(n1, n2, scaleMin) {
          ...
          diff = Libbcmath.bc_new_num(
            diffLen,
            Libbcmath.MAX(diffScale, scaleMin),
          );
