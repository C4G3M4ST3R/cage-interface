  ...
  <main>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="section-title text-center pb-40">
              <div class="line m-auto"></div>
              <h3 class="title">Ecosystem <span> </span></h3>
            </div>
            <!-- section title -->
          </div>
        </div>
    ...
    <section id="about" class="about-area pt-70">
      ...
      <div class="about-shape-1">
        <img
          class="img-fluid"
          src="/img/images/about-shape-1.svg"
          alt="shape"
        />
      </div>
    </section>
    ...
    <section class="about-area pt-70">
      <div class="about-shape-2">
        <img src="/img/images/about-shape-2.svg" alt="shape" />
      </div>
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-7 col-sm-8">
            ...
            >
              <div class="services-icon">
                <img
                  class="shape"
                  src="/img/images/services-shape.svg"
                  alt="shape"
                />
                <img
                  class="shape-1"
                  src="/img/images/services-shape-1.svg"
                  alt="shape"
                />
          ...
          <div class="col-lg-4 col-md-7 col-sm-8">
            ...
            >
              <div class="services-icon">
                ...
                <img
                  class="shape-1"
                  src="/img/images/services-shape-2.svg"
                  alt="shape"
                />
                <i class="lni-cog"></i>
              </div>
          ...
          <div class="col-lg-4 col-md-7 col-sm-8">
            ...
            >
              <div class="services-icon">
                ...
                <img
                  class="shape-1"
                  src="/img/images/services-shape-3.svg"
                  alt="shape"
                />
    ...
    <section id="facts" class="video-counter pt-70" style="margin-bottom: 50px">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div
              ...
              data-wow-delay="0.5s"
            >
              <img class="dots" src="/img/images/dots.svg" alt="dots" />
            ...
            >
              <div class="counter-content">
                ...
                <p class="text">
                  ...
                  track the performance of five tokens; four top meme tokens and
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="section-title text-center pb-40">
              <div class="line m-auto"></div>
              <h3 class="title">Featured on <span> </span></h3>
            </div>
            <!-- section title -->
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="section-title text-center pb-40">
              <div class="line m-auto"></div>
              <h3 id="map" class="title">Road Map <span> </span></h3>
            </div>
            <!-- section title -->
          </div>
        </div>
              ...
              >
                <a href="#" class="timeline-content">
                  ...
                  <p class="description">
                    ...
                    * Initial fund raise<br />
                    * Website launch<br />
                    * C4G3 Contract<br />
                    * Audit C4G3 Contract deployment<br />
                  </p>
                </a>
              </div>

              <div
                class="timeline wow fadeInRightBig"
                data-wow-duration="1s"
                data-wow-delay="0.5s"
              >
                <a href="#" class="timeline-content">
                  ...
                  <p class="description">
                    ...
                    * Marketing (This will be recurring)<br />
...
export default {
  ...
  mounted() {
    function scrollValue() {
      ...
      if (scroll < 40) {
        nov.classList.remove('BgColour');
      } else {
        nov.classList.add('BgColour');
      }
    }
